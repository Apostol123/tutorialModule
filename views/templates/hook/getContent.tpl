...
<input type="radio" id="enable_grades_1"
name="enable_grades" value="1" {if $enable_grades eq '1'} checked {/if}}/>
<label class="t" for="enable_grades_1">Yes</label>
<img src="../img/admin/disabled.gif" alt="" />
<input type="radio" id="enable_grades_0"
name="enable_grades" value="0" {if empty($enable_grades)|| $enable_grades eq '0'}checked{/if} />
...
name="enable_comments" value="1"  {if $enable_comments eq '1'} checked {/if}}/>
<label class="t" for="enable_comments_1">Yes</label>
<img src="../img/admin/disabled.gif" alt="" />
<input type="radio" id="enable_comments_0"
name="enable_comments" value="0" {if empty($enable_comments)|| $enable_comments eq '0'}checked{/if} />
